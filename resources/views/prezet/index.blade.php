...
<x-prezet.template>
    @seo([
        'title' => 'MoneyUnify Switch Documentation',
        'description' =>
            'Guides and API reference for MoneyUnify Switch — the self-hosted payment switch with one endpoint and automatic provider fallback.',
            ...
            <div class="space-y-2 pb-8 md:space-y-5">
                ...
                <div class="justify-between sm:flex">
                    <p class="text-lg leading-7 text-gray-500">
                        Everything you need to install, configure, and integrate the MoneyUnify Switch.
                    </p>
